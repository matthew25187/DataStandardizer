...
function Out-SourceCode {
    ...
    process {
        $status = "Evaluating code $($_.'ISO-alpha3 Code')"
        ...
        # Declare field.
        $enumField = [System.CodeDom.CodeMemberField]::new([ushort], $_.'ISO-alpha3 Code')
        ...
        $codeAttribute = [System.CodeDom.CodeAttributeDeclaration]::new('DataStandardizer.UNM49.UnM49CodeAttribute', $codeAttributeArguments)
