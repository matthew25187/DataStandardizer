---
title: ItuE164SubscriberNumber Struct
parent: Communication
grand_parent: Packages
nav_exclude: true
---

# ItuE164SubscriberNumber Struct

## Definition

Namespace: `DataStandardizer.Communication.E164`

The subscriber number field of a network, group-of-countries, or trial number.
...
| Constructor | Notes |
| --- | --- |
| `ItuE164SubscriberNumber(string value)` | Throws `ArgumentException` if `value` is not all digits. |
| `ItuE164SubscriberNumber(ulong value)` | |
...
| --- | --- | --- |
| Explicit | `explicit operator ItuE164SubscriberNumber(string)` | Throws `InvalidCastException` if not all digits. |
| Implicit | `implicit operator ItuE164SubscriberNumber(ulong)` | |
| Implicit | `implicit operator ulong(ItuE164SubscriberNumber)` | |
