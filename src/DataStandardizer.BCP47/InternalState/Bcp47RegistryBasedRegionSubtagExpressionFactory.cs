...
{
    internal class Bcp47RegistryBasedRegionSubtagExpressionFactory : IBcp47ExpressionFactory
    {
        private static readonly RegexOptions ExpressionOptions;

        private readonly SubtagRegistry.SubtagRegistry _subtagRegistry;

        static Bcp47RegistryBasedRegionSubtagExpressionFactory()
        {
        ...
        public Bcp47RegistryBasedRegionSubtagExpressionFactory(SubtagRegistry.SubtagRegistry subtagRegistry)
        {
        ...
        {
            var regionSubtags = _subtagRegistry
                .Where(record => record.Any(field => field.Item1 == FieldName.Type && field.Item2.Equals(Type.Region)))
                ...
                .Cast<string>();
            return string.Join("|", regionSubtags.Select(Regex.Escape));
        }
    }
}