# DataStandardizer.Chronology package
...
- TZ Database
    ...
    Supports the TZ Database for standardized timezone names

- Unix time

    Supports use of Unix time with conversion to and from standard date & time values
