...
namespace DataStandardizer.UNM49
{
    ...
    public sealed class UnM49CodeAttribute : CodeAttributeBase
    {
        #region Declarations
        ...
        public UnM49CodeAttribute(ushort globalCode) : this()
        {
            GlobalCode = globalCode;
        }

        public UnM49CodeAttribute(ushort globalCode, ushort regionCode) : this(globalCode)
        {
            RegionCode = regionCode;
        }

        public UnM49CodeAttribute(ushort globalCode, ushort regionCode, ushort subRegionCode) : this(globalCode, regionCode)
        {
            SubRegionCode = subRegionCode;
        }

        public UnM49CodeAttribute(ushort globalCode, ushort regionCode, ushort subRegionCode, ushort intermediateRegionCode) : this(globalCode, regionCode, subRegionCode)
        {
