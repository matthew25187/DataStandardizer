#################################################################################
# Title: ISO 639 Part 1: Alpha-2 Source Code Generator                          #
# Copyright: Copyright © 2025, Matthew25187. All rights reserved.               #
#                                                                               #
# Purpose: Generate source code for implementing the ISO 639: Part 1 standard.  #
...
#nullable enable
    ...
    process {
        if ([string]::IsNullOrEmpty($_.Part1Code)) {
            return;
        }

        $status = "Evaluating language code $($_.Part1Code)"
        ...
        $languageCodeField = [System.CodeDom.CodeMemberField]::new("readonly $(Get-Variable -Name SourceCodeNamespace -ValueOnly).$TypeName", "@$($_.Part1Code)")
        ...
        $languageCodeField.InitExpression = [System.CodeDom.CodeObjectCreateExpression]::new("$(Get-Variable -Name SourceCodeNamespace -ValueOnly).$TypeName", @([System.CodeDom.CodePrimitiveExpression]::new($_.Part1Code)))

        $languageCodeFieldOpenSummaryComment = [System.CodeDom.CodeCommentStatement]::new('<summary>', $true)
        $languageCodeFieldSummaryContentComment = [System.CodeDom.CodeCommentStatement]::new($_.EnglishName, $true)
        ...
        $part2BCode = $_.Part2bCode ?? $_.Part2tCode
        ...
        $part2TCode = $_.Part2tCode ?? $_.Part2bCode
