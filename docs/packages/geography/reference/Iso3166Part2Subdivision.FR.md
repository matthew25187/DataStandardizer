---
title: Iso3166Part2Subdivision.FR subdivisions
parent: Geography
grand_parent: Packages
nav_exclude: true
---

# Iso3166Part2Subdivision.FR subdivisions

ISO 3166-2 subdivisions under `Iso3166Part2Subdivision.FR`, members of [Iso3166Part2Subdivision](Iso3166Part2Subdivision.md).
...
| `FR-94` | Val-de-Marne |
| `FR-95` | Val-d\'Oise |
| `FR-971` | Guadeloupe (see also separate country code entry under GP) |
| `FR-972` | Martinique (see also separate country code entry under MQ) |
| `FR-973` | Guyane (française) (see also separate country code entry under GF) |
| `FR-974` | La Réunion (see also separate country code entry under RE) |
| `FR-976` | Mayotte (see also separate country code entry under YT) |
