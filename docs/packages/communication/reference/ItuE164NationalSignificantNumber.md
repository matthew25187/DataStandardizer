---
title: ItuE164NationalSignificantNumber Struct
parent: Communication
grand_parent: Packages
nav_exclude: true
---

# ItuE164NationalSignificantNumber Struct

## Definition

Namespace: `DataStandardizer.Communication.E164`

The national significant number (NSN) field that follows the country code of a
...
| Constructor | Notes |
| --- | --- |
| `ItuE164NationalSignificantNumber(string value)` | Throws `ArgumentException` if `value` is not all digits. |
| `ItuE164NationalSignificantNumber(ulong value)` | |
...
| --- | --- | --- |
| Explicit | `explicit operator ItuE164NationalSignificantNumber(string)` | Throws `InvalidCastException` if not all digits. |
| Implicit | `implicit operator ItuE164NationalSignificantNumber(ulong)` | |
| Implicit | `implicit operator ulong(ItuE164NationalSignificantNumber)` | |
