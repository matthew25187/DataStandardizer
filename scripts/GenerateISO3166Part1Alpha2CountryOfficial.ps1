#########################################################################
# Title: ISO 3166 Part 1 Alpha-2 Source Code Generator                  #
...
function Out-SourceCode {
    ...
    process {
        $status = "Evaluating script code $($_.alpha_2_code)"
        ...
        # Declare field.
        $enumField = [System.CodeDom.CodeMemberField]::new([ushort], $_.alpha_2_code)
