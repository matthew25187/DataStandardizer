#################################################################################
# Title: ISO 639 Part 5: Alpha-3 Source Code Generator                          #
# Copyright: Copyright © 2025, Matthew25187. All rights reserved.               #
#                                                                               #
# Purpose: Generate source code for implementing the ISO 639: Part 5 standard.  #
...
#nullable enable
        ...
        $structConstructor.Attributes = ($structConstructor.Attributes -band -bnot [System.CodeDom.MemberAttributes]::AccessMask) -bor [System.CodeDom.MemberAttributes]::Assembly
    ...
    process {
        $status = "Evaluating language code $($_.code)"
        ...
        $languageCodeField = [System.CodeDom.CodeMemberField]::new("readonly $(Get-Variable -Name SourceCodeNamespace -ValueOnly).$TypeName", "@$($_.code)")
        ...
        $languageCodeField.InitExpression = [System.CodeDom.CodeObjectCreateExpression]::new("$(Get-Variable -Name SourceCodeNamespace -ValueOnly).$TypeName", @([System.CodeDom.CodePrimitiveExpression]::new($_.code)))

        $languageCodeFieldOpenSummaryComment = [System.CodeDom.CodeCommentStatement]::new('<summary>', $true)
        $languageCodeFieldSummaryContentComment = [System.CodeDom.CodeCommentStatement]::new($_.'Label (English)', $true)
        ...
        $languageCodeFieldSeeAlsoComment = [System.CodeDom.CodeCommentStatement]::new("<seealso href=""$($_.URI)"">Library of Congress</seealso>", $true)
        [void]$languageCodeField.Comments.Add($languageCodeFieldSeeAlsoComment)

        $englishNames = $_.'Label (English)' -split ';'
        $frenchNames = $_.'Label (French)' -split ';'
...
try {
    ...
    $codeSet | Out-SourceCode -CodeProcessCount $codeCount -TypeName $SourceCodeTypeName -TypeComment $SourceCodeTypeComment -GenerateLanguage $SourceCodeLanguage
}
finally {
