---
title: UnM49AreaByAlpha3CountryCode Enum
parent: Geography
grand_parent: Packages
nav_exclude: true
---

# UnM49AreaByAlpha3CountryCode Enum

## Definition

Namespace: `DataStandardizer.Geography`

UN M49 area codes keyed by ISO 3166-1 alpha-3 country code. Each member is named
after an ISO 3166-1 alpha-3 code, and the member's underlying value is the
