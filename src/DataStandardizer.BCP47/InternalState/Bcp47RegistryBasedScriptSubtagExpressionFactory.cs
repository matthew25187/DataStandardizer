...
{
    internal class Bcp47RegistryBasedScriptSubtagExpressionFactory : IBcp47ExpressionFactory
    {
        private static readonly RegexOptions ExpressionOptions;

        private readonly SubtagRegistry.SubtagRegistry _subtagRegistry;

        static Bcp47RegistryBasedScriptSubtagExpressionFactory()
        {
        ...
        public Bcp47RegistryBasedScriptSubtagExpressionFactory(SubtagRegistry.SubtagRegistry subtagRegistry)
        {
        ...
        {
            var scriptSubtags = _subtagRegistry
                .Where(record => record.Any(field => field.Item1 == FieldName.Type && field.Item2.Equals(Type.Script)))
                ...
                .Cast<string>();
            return string.Join("|", scriptSubtags.Select(Regex.Escape));
        }
    }
}