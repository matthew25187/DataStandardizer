...
{
    internal class Bcp47RegistryBasedPrimaryLanguageSubtagExpressionFactory : IBcp47ExpressionFactory
    {
        private static readonly RegexOptions ExpressionOptions;

        private readonly SubtagRegistry.SubtagRegistry _subtagRegistry;

        static Bcp47RegistryBasedPrimaryLanguageSubtagExpressionFactory()
        {
        ...
        public Bcp47RegistryBasedPrimaryLanguageSubtagExpressionFactory(SubtagRegistry.SubtagRegistry subtagRegistry)
        {
        ...
        {
            var primaryLanguageSubtags = _subtagRegistry
                .Where(record => record.Any(field => field.Item1 == FieldName.Type && field.Item2.Equals(Type.PrimaryLanguage)))
                ...
                .Cast<string>();
            return string.Join("|", primaryLanguageSubtags.Select(Regex.Escape));
        }
    }
}